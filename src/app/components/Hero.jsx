      ...
      >
        <div className="max-w-3xl mx-auto py-20 text-center text-white">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mt-10">
              <button className="border bg-gradient-to-r from-purple-500 to-red-500 text-white font-bold py-2 px-4 rounded-3xl md:ml-8 hover:bg-indigo-400 duration-500 lg:text-sm">
                Apply Now
              </button>
              <button className="border bg-gradient-to-r from-red-500 to-purple-500 text-white font-bold py-2 px-4 rounded-3xl md:ml-8 hover:bg-indigo-400 duration-500 lg:text-sm">
                View all courses
              </button>
            </div>
          </div>
